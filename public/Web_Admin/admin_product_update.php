...
if (isset($_POST['update_product'])) {
    ...
    $update_product = $conn->prepare("UPDATE `products` SET name = ?, price = ?, cantidad = ? WHERE id = ?");
    $update_product->execute([$name, $price, $cantidad, $pid]);
