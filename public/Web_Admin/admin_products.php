...
if (isset($_POST['add_product'])) {
    ...
    if ($select_product->rowCount() > 0) {
        ...
        if ($image_size > 2000000) {
            ...
            $insert_product = $conn->prepare("INSERT INTO `products`(name, price, categoria, cantidad, image) VALUES(?,?,?,?,?)");
            $insert_product->execute([$name, $price, $category, $cantidad, $image]);
    ...
    while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
        ?>
                        <div class="box">
                            ...
                            <div class="cantidad">Cantidad: <span><?= $fetch_products['cantidad']; ?></span></div>
